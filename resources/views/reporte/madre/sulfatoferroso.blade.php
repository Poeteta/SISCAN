                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="tablasulfato" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>Tipos de Dosis de Sulfato Ferroso</th>
                                                        <th>Cantidad</th>
...
<script type="text/javascript">
   google.charts.load("current", {packages:['corechart']});
    ...
    function drawChart() {
      ...
      var optionssulfato = {
        title: "Reporte de Sulfato Ferroso",
        width: 500,
        height: 300,
        bar: {groupWidth: "75%"},
  ...
  $('#graph-imagessulfato').append(content);
});
...
@endpush
                                  ...
                                  <div class="card-body">
                                     <div id="sulfatoferroso" style="width: 500px; height: 300px;"></div>
                                      <div id="graph-imagessulfato" style='display:none'></div>
                                  </div>
