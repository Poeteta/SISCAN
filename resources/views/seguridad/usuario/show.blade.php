    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
            <div class="navbar-wrapper">
                <a class="navbar-brand" href="#pablo">Perfil Usuario</a>
            </div>
        </div>
    </nav>
    <!-- End Navbar -->
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 style="text-align: center;" class="title">Editar Perfil</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row" style="margin-top: 5%; margin-bottom: 5%;">
                                <div class="col-md-5 pr-1" style="margin-left: 5%;">
                                    <div class="form-group">
                                        <label style="margin-left: 4%; margin-bottom: 10%;">Nombre (s):</label>
